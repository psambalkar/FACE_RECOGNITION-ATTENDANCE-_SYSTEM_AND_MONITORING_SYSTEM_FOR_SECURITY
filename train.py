# -*- coding: utf-8 -*-
"""
Created on Sun March 5 2020

@author: Parth Ambalkar
"""
...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        detector=cv2.CascadeClassifier('C:/Users/PARTH/AppData/Roaming/Python/Python37/site-packages/cv2/data/haarcascade_frontalface_default.xml')
        sampleNum=0
        while(True):
            ret, img = cam.read()
...
def TrainImages():
    ...
    recognizer.save("C:/Users/PARTH/Desktop/Face-Recognition-Based-Attendance-System-master/face-trainner.yml")
...
def TrackImages():
    ...
    recognizer.read("C:/Users/PARTH/Desktop/Face-Recognition-Based-Attendance-System-master/face-trainner.yml")
    harcascadePath = "haarcascade_frontalface_default.xml"
    ...
    fileName="C:/Users/PARTH/Desktop/Face-Recognition-Based-Attendance-System-master/Attendance_"+date+"_"+Hour+"-"+Minute+"-"+Second+".csv"
...
#copyWrite.insert("insert", "Developed by Parth","", "TEAM", "superscript")
